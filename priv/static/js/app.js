...
channel.on("color_change", function (payload) {
...
channel.on("clear_canvas", function (_payload) {
...
function drawTo(from, to, color) {
	//send this to RoomChannel
...
channel.on("update_draw", function (payload) {
...
message.on("keypress", function (event) {
	//act accordingly if enter is pressed 
...
channel.on("update_post", function (details) {
